---
title: "Average Music Tempo in Latin America"
...
south$tempo <- as.integer(south$tempo)
#print(south$africa)
#geojsonio::geojson_write(south, file = "map-7.geojson")
bins <- c(100, 110, 120, 130, 140)
pal <- colorBin("YlOrRd", domain = south$tempo, bins = bins)
...
#print(labels2)
m %>% addPolygons(fillColor = ~pal(tempo),
  weight = 2,
  opacity = 1,
  ...
  labelOptions = labelOptions(
    ...
    textsize = "15px",
    direction = "auto"))%>%
 addLegend(pal = colorBin("YlOrRd", domain = south$tempo, bins = bins, reverse = TRUE), values = ~tempo, opacity = 0.7, title = "Average Tempo",
